...
func init(){
	...
	MongodbCmd.Flags().StringSliceP("collections-exclude", "e", []string{}, "name of the collections to exclude")
	MongodbCmd.Flags().StringP("output", "o", "json", "output type (json, bson, gzip)")
